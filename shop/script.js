    ...
    },
    {
        ...
        images: [
                    ...
                    "../images/IMG-20250704-WA0089.jpg",
                     "../images/IMG-20250810-WA00177.jpg",
                ]
    },
    {
        id: 12,
        ...
        images: [
                    ...
                    "../images/IMG-20250810-WA0109.jpg",
                     "../images/IMG-20250810-WA0134.jpg",
                    "../images/IMG-20250810-WA00091.jpg",
    ...
    },
    {
        ...
        function renderProducts(productsArray) {
            ...
            paginatedProducts.forEach(product => {
                ...
                // Generate slider HTML for products with multiple images
                let sliderHTML = '';
                ...
                // Add slider functionality for products with multiple images
                if (product.images && product.images.length > 1) {
                    ...
                    prevBtn.addEventListener('click', () => {
                        const prevSlide = currentSlide === 0 ? product.images.length - 1 : currentSlide - 1;
                        goToSlide(prevSlide);
                    ...
                    nextBtn.addEventListener('click', () => {
                        const nextSlide = currentSlide === product.images.length - 1 ? 0 : currentSlide + 1;
                        goToSlide(nextSlide);
                        currentSlide = nextSlide;
                        // Reset auto slide timer
                        stopAutoSlide();

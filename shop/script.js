...
const products = [
    ...
    },
    {
        ...
        minPrice: 400,
        maxPrice: 450,
        specs: ["Energy efficient", "1 year warranty","Easy to use"],
        minOrder: 1,
        shipping: "delivery",
        supplier: "Townssy",
        verified: true,
    ...
    {
        id: 4,
        name: "Nasco 4 Burner Gas Cooker with Oven",
        description: "Professional kitchen equipment",
        price: 2200,
        minPrice: 2200,
        maxPrice: 2500,
        specs: ["safety", "burners", "Ignition", "oven", "stainless steel", "control knobs"],
        minOrder: 1,
        shipping: "delivery",
        supplier: "Townssy",
        verified: true,
